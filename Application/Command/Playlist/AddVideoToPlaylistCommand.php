...
#[AsCommand(
    name: 'youtube:playlist:add-video',
    description: 'Add a video to a YouTube playlist'
)]
class AddVideoToPlaylistCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $io->info("Adding video {$videoId} to playlist {$playlistId}...");
            ...
            $io->success('Video added to playlist successfully!');
