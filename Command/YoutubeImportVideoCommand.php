...
class YoutubeImportVideoCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('tags', null, InputOption::VALUE_IS_ARRAY | InputOption::VALUE_OPTIONAL, 'Youtube tags to add in the object', [])
...
EOT
    ...
    {
        $tags = $this->tagRepo->findBy(['properties.origin' => 'youtube', 'properties.youtube' => ['$in' => $tagIds]]);
    ...
    private function getSeries($seriesId)
    {
        ...
        $series = $this->seriesRepo->findOneBy(['properties.origin' => 'youtube', 'properties.fromyoutubetag' => $seriesId]);
        if ($series) {
        ...
        //tag with youtube
        $tag = $this->tagRepo->findOneBy(['properties.origin' => 'youtube', 'properties.youtube' => $seriesId]);
        if ($tag) {
    ...
    private function getStatus($status)
    {
        ...
        $validStatus = ['published', 'pub', 'block', 'bloq', 'blocked', 'hide', 'hidden'];
