...
final class AddToPlaylistsController extends AbstractController
{
    ...
    /**
     * @Route("/admin/youtube/video/{multimediaObjectId}/add-to-playlists", name="pumukit_youtube_video_add_to_playlists", methods={"POST"})
     */
    public function __invoke(string $multimediaObjectId, Request $request): JsonResponse
    {
        ...
        // Dispatch message to add video to playlists
        ...
        return new JsonResponse([
            'status' => 'enqueued',
            'message' => 'Video will be added to ' . count($data['playlistIds']) . ' playlist(s)',
            'multimediaObjectId' => $multimediaObjectId,
            'youtubeId' => $youtubeId,
